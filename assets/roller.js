    ...
    window.CUBER = {
        ...
        Product: {
            ...
            mount: function($product) {
                ...
                .bind(_this)),
                _this.$productGallery.hasClass("slider") && (_this.$productGallery.find(".gallery-index").append('<span class="icon-go go-prev">' + $2.themeAssets.arrowRight + '</span><span class="icon-go go-next">' + $2.themeAssets.arrowRight + "</span>"),
        ...
        SplitSlider: {
            _mountFlickity: function() {
                ...
                $slider.append('<div class="slider-meta hide lap--show"><div class="slider-index"><span class="current">1</span> / <span class="total">' + sliderT + '</span></div><div class="slider-nav"><span class="go-prev">' + $2.themeAssets.arrowRight + '</span><span class="go-next">' + $2.themeAssets.arrowRight + "</span></div>"),
